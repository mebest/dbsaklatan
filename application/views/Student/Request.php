    ...
    <div class="cell auto-size padding20 bg-white" id="cell-content">  
        ...
        <div class="flex-grid">
            ...
            <div class="row cells4">
                ...
                <div class="frame" id="Request">
                    <form action="<?php echo site_url('ElibrarySystem/request_book?access='.$book_info['access'].'&title='.$book_info['title'].'&author='.$book_info['author'].'') ?>" method="post">
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="cell padding10 colspan7 full-size">
                    <button class="button bg-red">Request</button>
                </div>
            </div>
